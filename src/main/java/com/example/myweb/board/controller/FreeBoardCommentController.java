...
public class FreeBoardCommentController {
	...
	public ResponseEntity save(@ModelAttribute FreeBoardCommentDTO freeBoardCommentDTO) {
		...
		if (saveResult != null) {
			...
			// 댓글목록: 해당 게시글의 댓글 전체
			List<FreeBoardCommentDTO> freeBoardCommentDTOList = freeBoardCommentService
					.findAll(freeBoardCommentDTO.getFreeBoardSeq());
    ...
    public @ResponseBody String update(@RequestParam("commentSeq") Long commentSeq,
        ...
        Long updatedSeq = freeBoardCommentService.updateComment(commentSeq, newContent);
	...
	public @ResponseBody String deleteComment(@RequestParam("commentSeq") Long commentSeq) {
		...
		boolean success = freeBoardCommentService.deleteComment(commentSeq);
