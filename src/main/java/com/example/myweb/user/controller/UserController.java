...
public class UserController {
	...
	public String login(@ModelAttribute UserDTO userDTO,
			@RequestParam(value = "rememberMe", defaultValue = "false") boolean rememberId, HttpSession session,
	...
	// 사용자 역할을 반환하는 엔드포인트 추가
	@GetMapping("/user/role")
	@ResponseBody
	public String getUserRole(HttpSession session) {
		String role = (String) session.getAttribute("role");
		return role != null ? role : "guest"; // role이 null일 경우 'guest' 반환
	}
